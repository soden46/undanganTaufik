            ...
            <div class="text-center pt-4">
                ...
                <div class="py-4">
                    <div class="img-crop border border-3 border-light shadow mx-auto">
                        <img src="{{ asset('assets/images/10.webp')}}" alt="bg" class="w-100" onclick="util.modal(this)" loading="lazy"/>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">
                        ...
                        <div class="row justify-content-center" data-waktu="2024-07-01 00:00:00" id="tampilan-waktu">
                            <div class="col-3 p-1">
                    ...
                    <div class="overflow-x-hidden">
                        <div class="py-2" data-aos="fade-right" data-aos-duration="1500">
                            <h1 class="font-esthetic" style="font-size: 2rem">Akad Nikah</h1>
                            <p>Pukul 10.00 WIB - Selesai</p>
                        </div>
                    </div>

                    <div class="py-2" data-aos="fade-up" data-aos-duration="1500">
                        <a href="https://maps.app.goo.gl/apHBhxWzxsRfzRs17" target="_blank" class="btn btn-outline-light btn-sm rounded-pill shadow-sm mb-2 px-3" loading="lazy">
                    ...
                    <div id="carousel-foto-satu" data-aos="fade-up" data-aos-duration="1500" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <div style="width: 100%"><iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3974.021170906891!2d105.2795!3d-5.100277799999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNcKwMDYnMDEuMCJTIDEwNcKwMTYnNDYuMiJF!5e0!3m2!1sid!2sid!4v1714395486694!5m2!1sid!2sid"><a href="https://www.gps.ie/">gps tracker sport</a></iframe></div>
                            </div>
                        </div>
                    </div>
        </section>
    ...
    <!-- Audio Button -->
    <button type="button" id="tombol-musik" style="display: none" class="btn btn-light btn-sm rounded-circle btn-music" onclick="util.music(this)" data-status="true" data-url="{{ asset('assets/music/sound2.mp3')}}">
    ...
    <div class="loading-page" id="loading" style="opacity: 1;">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
            <div class="text-center w-75">
                ...
                <noscript>
                    <small class="mt-1 text-danger">Maaf, undangan ini perlu javascript</small>
                </noscript>
            </div>
        </div>
    </div>
