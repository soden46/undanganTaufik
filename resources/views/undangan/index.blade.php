                ...
                <div class="overflow-x-hidden">
                    <div data-aos="fade-right" data-aos-duration="2000">
                        <div class="img-crop border border-3 border-light shadow my-4 mx-auto">
                            <img src="{{ asset('assets/images/11.webp')}}" alt="taufik" onclick="util.modal(this)" />
                        </div>
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000">
                        <div class="img-crop border border-3 border-light shadow my-4 mx-auto">
                            <img src="{{ asset('assets/images/12.webp')}}" alt="citra" onclick="util.modal(this)" />
                        </div>
            ...
            <div class="container pb-2 pt-4">
                <div class="card-body border rounded-4 shadow p-3">
                    ...
                    <div id="carousel-foto-satu" data-aos="fade-up" data-aos-duration="1000" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <img src="{{ asset('assets/images/1.webp')}}" alt="gambar 1" class="d-block w-100" onclick="util.modal(this)" />
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/3.webp')}}" alt="gambar 2" class="d-block w-100" onclick="util.modal(this)" />
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/4.webp')}}" alt="gambar 3" class="d-block w-100" onclick="util.modal(this)" />
                            </div>
                        </div>
